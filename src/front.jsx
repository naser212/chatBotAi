      ...
      transition={{
        ...
        >
            <div className="flex flex-col md:text-center bg-purp md:mx-36 md:my-16 md:space-y-12 text-lato md:px-36 md:py-14 md:mt-44 text-white rounded-lg">
                ...
                <p className="text-base font-semibold">Your personalized AI advisor for academic success. Get tailored course recommendations,
                     career guidance, and instant support to enhance your educational journey. Start chatting now to receive expert advice whenever you need it.</p>
                <Formm/>
            </div>
